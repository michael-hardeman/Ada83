...
-- OBJECTIVE:
--     CHECK THAT IF SIZE AND SMALL SPECIFICATIONS ARE GIVEN FOR A
--     FIXED POINT TYPE, THEN OPERATIONS ON VALUES OF SUCH A TYPE ARE
--     NOT AFFECTED BY THE REPRESENTATION CLAUSE, FOR THE SMALLEST
--     SIZE APPROPRIATE FOR A SIGNED REPRESENTATION.

-- HISTORY:
--     BCB 08/24/87  CREATED ORIGINAL TEST.
--     RJW 05/24/89  CHANGED EXTENSION FROM 'DEP' TO 'ADA'.

WITH REPORT; USE REPORT;
PROCEDURE CD2A54A IS
     ...
     BEGIN
          ...
          IF IDENT (CN1IN) + CP1IN NOT IN -2.875 .. -2.8125 OR
             CP2INOUT  - IDENT (CP1IN) NOT IN 2.8125 .. 2.875 THEN
...
BEGIN
     TEST ("CD2A54A", "CHECK THAT IF SIZE AND SMALL SPECIFICATIONS " &
                      "ARE GIVEN FOR A FIXED POINT TYPE, THEN " &
                      "OPERATIONS ON VALUES OF SUCH A TYPE ARE NOT " &
                      "AFFECTED BY THE REPRESENTATION CLAUSE FOR " &
                      "THE SMALLEST SIZE APPROPRIATE FOR A SIGNED " &
                      "REPRESENTATION");
     ...
     IF IDENT (CHARRAY (0)) + CHARRAY (2) NOT IN -2.875 .. -2.8125 OR
        CHARRAY (3)  - IDENT (CHARRAY (2)) NOT IN 2.8125 .. 2.875 THEN
     ...
     IF IDENT (CHREC.COMPF) + CHREC.COMPP NOT IN -2.875 .. -2.8125 OR
        CHREC.COMPL  - IDENT (CHREC.COMPP) NOT IN 2.8125 .. 2.875 THEN
