...
--     CODES ARE ALLOWED IN GENERIC UNITS, CHECK THAT WHEN THERE IS
--     AN ENUMERATION CLAUSE FOR THE PARENT, THE TYPE CAN BE USED
--     CORRECTLY IN ORDERING RELATIONS, INDEXING ARRAYS, AND IN GENERIC
--     INSTANTIATIONS.
...
PROCEDURE CD3015J IS

BEGIN

     TEST ("CD3015J", "IF ENUMERATION REPRESENTATION CLAUSES WITH " &
                      "NON-CONTIGUOUS CODES ARE ALLOWED IN GENERIC " &
                      "UNITS, CHECK THAT WHEN THERE IS AN ENUMERATION" &
