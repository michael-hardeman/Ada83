...
SEPARATE (D64005F0M.D64005FA.D64005FB.D64005FC)
...
BEGIN
     ...
     T.S (T.E+1 .. T.E+N) := D64005F0M.V & D64005FA.V & D64005FB.V &
                             D64005FC.V & D64005FD.V;
     T.E := T.E + N;

     CASE C IS

          WHEN '1' =>
               D64005FE (LEVEL'SUCC(L), IDENT_CHAR('1'), T);

          WHEN '2' =>
               D64005FD (L, IDENT_CHAR('3'), T);

          WHEN '3' =>
               D64005FE (LEVEL'SUCC(L), IDENT_CHAR('2'), T);
     END CASE;

     -- APPEND ALL L AND C TO T IN REVERSE ORDER.
     T.S (T.E+1 .. T.E+N) := D64005FD.L & D64005FD.C &
