...
-- OBJECTIVE:
--     DETERMINE, FOR SEQUENTIAL_IO, THE NUMBER OF INTERNAL FILES AN
...
BEGIN
     ...
     TEST ("CE2117A", "DETERMINE, FOR SEQUENTIAL_IO, THE NUMBER OF " &
     ...
     BEGIN
          ...
          IF LOOP_COUNT = 65 THEN
               COMMENT ("FOR SEQUENTIAL_IO, THIS IMPLEMENTATION CAN " &
