...
PROCEDURE C52012A IS
     ...
     TYPE SHORT_ARR IS ARRAY (1..3) OF SMALL;
     TYPE LONG_ARR IS ARRAY (1..10) OF SMALL;

BEGIN
     TEST ("C52012A", "CHECK THAT TARGET VARIABLE VALUE IS UNCHANGED " &
     ...
     BEGIN
          I := 5;
          J := 6;
          A3 := A4 (2..5) & A4 (7 .. I + J);   -- ERROR: CONSTRAINT
     ...
     BEGIN
          K := 5;
          L := 0;
          A5 := A6 (4..9) & A6 (7..K/L);       -- ERROR: DIVISION BY 0
