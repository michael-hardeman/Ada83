...
-- DISCRIMINANTS, OR TO AN ARRAY OBJECT, OR TO THE VALUE OF A FUNCTION
-- RETURNING A RECORD OBJECT THAT HAS DISCRIMINANTS.   CHECK FOR
...
-- CHECK THAT 'CONSTRAINED CANNOT BE APPLIED TO A FUNCTION RETURNING
-- AN ACCESS VALUE DESIGNATING A RECORD WITH DISCRIMINANTS NOR TO AN
-- ACCESS VARIABLE DESIGNATING SUCH AN OBJECT.
...
BEGIN
     DECLARE
          ...
          ERR25 : B := F1'CONSTRAINED;        -- ERROR: 'CONSTRAINED.
          ERR26 : B := F2'CONSTRAINED;        -- ERROR: 'CONSTRAINED.
          OK27  : B := F2.ALL'CONSTRAINED;    -- OK.
          R2N : REC2_NAME := NEW REC2;
          ERR28 : B := R2N'CONSTRAINED;       -- ERROR: 'CONSTRAINED.
