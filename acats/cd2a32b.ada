...
--     INTEGER TYPE IN A GENERIC PROCEDURE THEN
--     OPERATIONS ON VALUES OF SUCH A TYPE WITH THE SMALLEST
...
PROCEDURE CD2A32B IS

     BASIC_SIZE : CONSTANT := 7;

BEGIN

     TEST ("CD2A32B", "CHECK THAT WHEN A SIZE SPECIFICATION IS " &
                      "GIVEN FOR AN INTEGER TYPE IN A GENERIC " &
                      "PROCEDURE, THEN OPERATIONS ON " &
                      "VALUES OF SUCH A TYPE WITH " &
