...
-- FOR OUT ARRAY PARAMETERS, WHERE THE ACTUAL PARAMETER HAS THE FORM
...
PROCEDURE C64105F IS

BEGIN
     TEST ("C64105F", "CHECK THAT CONSTRAINT_ERROR IS NOT RAISED " &
           "BEFORE OR AFTER THE CALL FOR OUT ARRAY PARAMETERS, " &
     ...
     DECLARE -- (C)
          ...
          AR : ARRAY_TYPE (2..1, 1..2);
          CALLED : BOOLEAN := FALSE;

          PROCEDURE P3 (X : OUT FORMAL) IS
          BEGIN
