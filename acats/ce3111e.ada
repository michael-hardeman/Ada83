...
--     VERSIONS OF THE FILE.  THIS TEST USES THE NAME FUNCTION IN
--     THE CALL TO OPEN.

-- APPLICABILITY CRITERIA:
--     THIS TEST IS APPLICABLE ONLY FOR IMPLEMENTATIONS WHICH
...
PROCEDURE CE3111E IS
     FILE1, FILE2 : FILE_TYPE;
     INCOMPLETE, SUBTEST : EXCEPTION;
     CHAR         : CHARACTER;
BEGIN

     TEST ("CE3111E", "CHECK THAT OPEN DOES NOT CREATE A NEW VERSION " &
                      "OF AN EXTERNAL FILE");
