...
BEGIN
     ...
     TEST( "C52104X" , "CHECK THAT IN ARRAY ASSIGNMENTS AND IN SLICE " &
                       ...
                       "CHECK WHETHER NUMERIC_ERROR/CONSTRAINT_ERROR " &
...
NUM_ERR:            -- THIS BLOCK CATCHES NUMERIC_ERROR/CONSTRAINT_ERROR
...
DCL_ARR:  DECLARE        -- THIS BLOCK DECLARES THE ARRAY SUBTYPE.
               ...
               -- NUMERIC_ERROR/CONSTRAINT_ERROR MAY BE RAISED BY THIS
               -- SUBTYPE DECLARATION.

          BEGIN

               COMMENT ("NO NUMERIC_ERROR/CONSTRAINT_ERROR FOR TYPE " &
...
OBJ_DCL:       DECLARE   -- THIS BLOCK DECLARES TWO BOOLEAN ARRAYS THAT
               ...
               COMMENT ("NO STORAGE_ERROR OR NUMERIC_ERROR/" &
...
DO_SLICE:      BEGIN
               ...
               EXCEPTION
                    ...
                    WHEN NUMERIC_ERROR =>
                         ...
                         COMMENT ("NUMERIC_ERROR RAISED DURING CHECK " &
          ...
          EXCEPTION
               ...
               WHEN NUMERIC_ERROR =>
                    COMMENT ("NUMERIC_ERROR RAISED WHEN DECLARING " &
                             "TWO PACKED BOOLEAN ARRAYS WITH " &
                             "INTEGER'LAST + 3 COMPONENTS");
               WHEN CONSTRAINT_ERROR =>
