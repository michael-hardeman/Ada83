...
SEPARATE (D64005G0M.D64005GA.D64005GB.D64005GC.D64005GD.D64005GE.
          D64005GF.D64005GG.D64005GH.D64005GI.D64005GJ)

PROCEDURE D64005GK (L : LEVEL; C : CALL; T : IN OUT TRACE) IS
...
BEGIN
     ...
     CASE C IS
          ...
          WHEN '1' =>
               D64005GL (LEVEL'SUCC(L), IDENT_CHAR('1'), T);

          WHEN '2' =>
               D64005GK (L, IDENT_CHAR('3'), T);

          WHEN '3' =>
               D64005GL (LEVEL'SUCC(L), IDENT_CHAR('2'), T);
     END CASE;

     -- APPEND ALL L AND C TO T IN REVERSE ORDER.
     T.S (T.E+1 .. T.E+N) := D64005GK.L & D64005GK.C &
