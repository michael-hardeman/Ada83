...
-- CHECK IF_STATEMENTS WITH DYNAMIC CONDITIONS.
...
BEGIN
     TEST ("C53005B","CONTROL FLOWS CORRECTLY IN BASIC NON-NESTED " &
     ...
     IF IDENT_BOOL(FALSE) THEN
          FAILED("DYNAMIC BOOLEAN LITERAL FALSE CONDITION");
     END IF;
     ...
     IF IDENT_BOOL(TRUE) THEN
          ...
          GOTO L1;
     END IF;
     FAILED("DYNAMIC BOOLEAN LITERAL TRUE CONDITION");
<<L1>> NULL;
