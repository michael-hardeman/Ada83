...
PROCEDURE BC3403B IS
     ...
     PACKAGE P3 IS NEW P (INTEGER, AN);                -- OK.
     ...
     PACKAGE PIU2 IS NEW PU (INTEGER, ANU);            -- OK.
     ...
     PACKAGE PI2 IS NEW PP (INTEGER, INTEGER, AIN);    -- OK.
     PACKAGE PI3 IS NEW PP (INTEGER, INTEGER, ANI);    -- OK.
