...
SEPARATE (D64005F0M.D64005FA.D64005FB.D64005FC.D64005FD)

PROCEDURE D64005FE (L : LEVEL; C : CALL; T : IN OUT TRACE) IS
     ...
     PROCEDURE D64005FF (L : LEVEL; C : CALL; T : IN OUT TRACE) IS
          SEPARATE;
...
BEGIN
     ...
     CASE C IS
          ...
          WHEN '1' =>
               D64005FF (LEVEL'SUCC(L), IDENT_CHAR('1'), T);

          WHEN '2' =>
               D64005FE (L, IDENT_CHAR('3'), T);

          WHEN '3' =>
               D64005FF (LEVEL'SUCC(L), IDENT_CHAR('2'), T);
     END CASE;

     -- APPEND ALL L AND C TO T IN REVERSE ORDER.
     T.S (T.E+1 .. T.E+N) := D64005FE.L & D64005FE.C &
