...
--     CODES ARE ALLOWED, CHECK THAT WHEN THERE IS AN ENUMERATION
...
PROCEDURE CD3015L IS

BEGIN

     TEST ("CD3015L", "IF ENUMERATION REPRESENTATION CLAUSES " &
                      "WITH NON-CONTIGUOUS CODES ARE ALLOWED, " &
                      "CHECK THAT WHEN THERE IS AN ENUMERATION " &
