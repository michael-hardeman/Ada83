...
--     WITHIN A GENERIC UNIT, THEN OPERATIONS ON THE TYPE ARE NOT
--     AFFECTED.
...
PROCEDURE CD2A24F IS

     BASIC_SIZE : CONSTANT := 3;

BEGIN
     TEST ("CD2A24F", "CHECK THAT IF A SIZE CLAUSE (SPECIFYING " &
                      "THE SMALLEST APPROPRIATE SIZE FOR AN " &
                      "UNSIGNED REPRESENTATION) AND AN ENUMERATION " &
                      "REPRESENTATION CLAUSE ARE GIVEN FOR AN " &
                      "ENUMERATION TYPE WITHIN A GENERIC UNIT, THEN " &
                      "OPERATIONS ON THE TYPE ARE NOT AFFECTED");
