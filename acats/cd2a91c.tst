...
--     THE VISIBLE OR PRIVATE PART OF A PACKAGE, OR FOR DERIVED TASK
--     TYPES, OR FOR A DERIVED PRIVATE TYPE WHOSE FULL DECLARATION IS
--     A TASK TYPE.
...
BEGIN
     TEST ("CD2A91C", "CHECK THAT A SIZE SPECIFICATION FOR A TASK " &
                      ...
                      "PART OF A PACKAGE, OR FOR DERIVED TASK " &
                      "TYPES, OR FOR A DERIVED PRIVATE TYPE WHOSE " &
                      "FULL DECLARATION IS A TASK TYPE");
     ...
     IF DERIVED_PRIV_TASK'SIZE /= IDENT_INT (BASIC_SIZE) THEN
          FAILED ("INCORRECT VALUE FOR DERIVED_PRIV_TASK'SIZE");
     END IF;
