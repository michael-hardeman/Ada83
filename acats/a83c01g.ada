...
WITH REPORT;
PROCEDURE  A83C01G  IS

     USE REPORT;

BEGIN

     TEST( "A83C01G" , "CHECK THAT COMPONENT NAMES MAY BE THE SAME AS" &
                       " NAMES OF PACKAGES" ) ;


     -- TEST FOR NAMES OF PACKAGES (AND OF INCLUDED SUBPROG.S, ARG.S)
     --    (THE RECORD IS INSIDE THE PACKAGE)
     ...
     DECLARE
          ...
          BEGIN
               ...
               PACK1.P2( ARG1.P1 , ARG1.PACK1 ,
                         ARG1.PACK2.PACK1+ARG1.PACK2.PACK2 );
               ARG1.PACK2.PACK1 :=
                         F1( ARG1.PACK2.ARG1 , ARG1.PACK2.ARG2 );

          END PACK2 ;

     BEGIN

          PACK1.P2( PACK1.ARG1.P1 , PACK1.ARG1.PACK1 ,
                    PACK1.ARG1.PACK2.PACK1+PACK1.ARG1.PACK2.PACK2 );
          PACK1.ARG1.PACK2.PACK1 :=
             PACK2.F1 ( PACK1.ARG1.PACK2.ARG1 , PACK1.ARG1.PACK2.ARG2 );
