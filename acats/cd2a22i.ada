...
BEGIN
     TEST ("CD2A22I", "IF A SIZE CLAUSE SPECIFIES THE SMALLEST " &
                      "APPROPRIATE SIZE FOR A SIGNED REPRESENTATION " &
                      "FOR AN ENUMERATION TYPE, THEN THE TYPE CAN " &
                      "BE USED AS AN ACTUAL PARAMETER IN AN " &
                      "INSTANTIATION");
