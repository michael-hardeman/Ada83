...
-- OBJECTIVE:
--     IF ENUMERATION REPRESENTATION CLAUSES ARE ALLOWED
--     IN GENERIC UNITS, CHECK THAT WHEN THERE IS NO ENUMERATION
--     CLAUSE FOR THE PARENT, THE TYPE CAN BE USED CORRECTLY IN ORDERING
--     RELATIONS, INDEXING ARRAYS, AND IN GENERIC INSTANTIATIONS.
...
PROCEDURE CD3015D IS

BEGIN

     TEST ("CD3015D", "IF ENUMERATION REPRESENTATION CLAUSES " &
                      "ARE ALLOWED IN GENERIC UNITS, " &
                      "CHECK THAT WHEN THERE IS NO ENUMERATION " &
                      "CLAUSE FOR THE PARENT, THE TYPE " &
     ...
     DECLARE
          ...
          PACKAGE GENPACK IS
               ...
               TYPE CHECK_TYPE IS (JACK, QUEEN, KING);
