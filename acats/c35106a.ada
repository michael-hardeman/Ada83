...
-- CHECK THAT AN ENUMERATION TYPE CAN HAVE MORE THAN 256 ENUMERATION
-- LITERALS.

-- R.WILLIAMS 8/20/86

WITH REPORT; USE REPORT;
PROCEDURE C35106A IS
...
BEGIN
     ...
     TEST ( "C35106A", "CHECK THAT AN ENUMERATION TYPE CAN HAVE " &
                       "THAN 256 ENUMERATION LITERALS" );

     IF E260'POS (A1) = 0 AND E260'POS (ZA) = 259 THEN
          NULL;
     ELSE
          FAILED ( "DECLARATION OF E260 HANDLED INCORRECTLY" );
     END IF;

     IF NE260'POS (A1) = 0 AND NE260'POS (ZA) = 259 THEN
          NULL;
     ELSE
          FAILED ( "DECLARATION OF NE260 HANDLED INCORRECTLY" );
     END IF;
