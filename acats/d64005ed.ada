...
SEPARATE (D64005E0M.D64005EA.D64005EB.D64005EC)

PROCEDURE D64005ED (L : LEVEL; C : CALL; T : IN OUT TRACE) IS
...
BEGIN
     ...
     T.S (T.E+1 .. T.E+N) := D64005E0M.V & D64005EA.V & D64005EB.V &
                             D64005EC.V & D64005ED.V;
     T.E := T.E + N;

     CASE C IS

          WHEN '1' =>
               D64005EE (LEVEL'SUCC(L), IDENT_CHAR('1'), T);

          WHEN '2' =>
               D64005ED (L, IDENT_CHAR('3'), T);

          WHEN '3' =>
               D64005EE (LEVEL'SUCC(L), IDENT_CHAR('2'), T);
     END CASE;

     -- APPEND ALL L AND C TO T IN REVERSE ORDER.
     T.S (T.E+1 .. T.E+N) := D64005ED.L & D64005ED.C &
