...
PROCEDURE BA1010D2 (J : IN INTEGER) IS     -- ERROR: DOESN'T MATCH SPEC.
BEGIN
     NULL;
END BA1010D2;

PROCEDURE BA1010D3 (I : IN OUT POSITIVE) IS
                                           -- ERROR: DOESN'T MATCH SPEC.
BEGIN
     I := 1;
END BA1010D3;

PROCEDURE BA1010D4 (I : OUT POSITIVE) IS   -- ERROR: DOESN'T MATCH SPEC.
BEGIN
     I := 1;
END BA1010D4;

PROCEDURE BA1010D5 (J : IN INTEGER; I : OUT INTEGER) IS
                                           -- ERROR: DOESN'T MATCH SPEC.
BEGIN
     I := 0;
END BA1010D5;
