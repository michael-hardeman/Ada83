...
PROCEDURE D64005GM (L : LEVEL; C : CALL; T : IN OUT TRACE) IS
...
BEGIN
     ...
     T.S (T.E+1 .. T.E+N) := D64005G0M.V & D64005GA.V & D64005GB.V &
                             ...
                             D64005GL.V & D64005GM.V;
     T.E := T.E + N;

     CASE C IS

          WHEN '1' =>
               D64005GN (LEVEL'SUCC(L), IDENT_CHAR('1'), T);

          WHEN '2' =>
               D64005GM (L, IDENT_CHAR('3'), T);

          WHEN '3' =>
               D64005GN (LEVEL'SUCC(L), IDENT_CHAR('2'), T);
     END CASE;

     -- APPEND ALL L AND C TO T IN REVERSE ORDER.
     T.S (T.E+1 .. T.E+N) := D64005GM.L & D64005GM.C &
