...
BEGIN
     ...
     IF 15#3D28188D45881111111111.0# <
                                  (((2.0 ** 21) -2.0) * (2.0 ** 63)) OR
        15#3D28188D45881111111111.0# > CHECK'LARGE THEN
          FAILED ("INCORRECT VALUE FOR BASE 15 REAL LITERAL");
     END IF;

     IF 16#FFFFF8000000000000000.0# /= CHECK'LARGE THEN
          FAILED ("INCORRECT VALUE FOR BASE 16 REAL LITERAL");
     END IF;
