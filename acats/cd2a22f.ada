...
--     CLAUSE WHEN THE CLAUSE SPECIFIES THE SMALLEST SIZE APPROPRIATE
...
PROCEDURE CD2A22F IS

     BASIC_SIZE : CONSTANT := 2;

BEGIN
     TEST ("CD2A22F", "CHECK THAT IF A SIZE CLAUSE IS " &
                      "GIVEN FOR AN ENUMERATION TYPE WITHIN A " &
                      "GENERIC UNIT, THEN OPERATIONS ON " &
                      "VALUES OF SUCH A TYPE ARE NOT AFFECTED BY " &
                      "THE REPRESENTATION CLAUSE WHEN THE CLAUSE " &
                      "SPECIFIES THE SMALLEST SIZE APPROPRIATE FOR " &
