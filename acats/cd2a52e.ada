...
--     ARE NOT AFFECTED BY THE REPRESENTATION CLAUSE FOR THE SMALLEST
--     SIZE APPROPRIATE FOR AN UNSIGNED REPRESENTATION.
...
BEGIN
     TEST ("CD2A52E", "CHECK THAT WHEN A SIZE SPECIFICATION IS " &
                      "GIVEN FOR A FIXED POINT TYPE, THEN " &
                      "OPERATIONS ON VALUES OF SUCH A TYPE ARE " &
                      "NOT AFFECTED BY THE REPRESENTATION CLAUSE FOR " &
                      "THE SMALLEST SIZE APPROPRIATE FOR AN UNSIGNED " &
                      "REPRESENTATION");
