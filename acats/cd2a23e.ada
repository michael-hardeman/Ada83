...
--      REPRESENTATION CLAUSE ARE GIVEN FOR AN ENUMERATION TYPE IN
--     A GENERIC UNIT, THEN SUCH A TYPE CAN BE PASSED AS AN ACTUAL
...
BEGIN
     TEST ("CD2A23E", "CHECK THAT WHEN A SIZE SPECIFICATION AND AN " &
                      ...
                      "GENERIC UNIT, THEN SUCH A TYPE CAN BE " &
