...
-- TEST WHERE THE INSTANTIATIONS APPEAR AFTER THE GENERIC BODY.
...
BEGIN
     DECLARE
     PACKAGE N1 IS NEW PK(REC, CREC, CREC, CREC);  -- ERROR: REC IS
                                                   -- UNCONSTRAINED.
     PACKAGE N2 IS NEW PK(CREC, REC, CREC, CREC);  -- ERROR: REC IS
                                                   -- UNCONSTRAINED.
     PACKAGE N3 IS NEW PK(CREC, CREC, REC, CREC);  -- ERROR: REC IS 
                                                   -- UNCONSTRAINED.
     PACKAGE N4 IS NEW PK(CREC, CREC, CREC, REC);  -- ERROR: REC IS
                                                   -- UNCONSTRAINED.
     PACKAGE N5 IS NEW PK(DREC, CREC, CREC, CREC); -- OK: AI-00037
     PACKAGE N6 IS NEW PK(CREC, DREC, CREC, CREC); -- OK: AI-00037
     PACKAGE N7 IS NEW PK(CREC, CREC, DREC, CREC); -- OK: AI-00037
     PACKAGE N8 IS NEW PK(CREC, CREC, CREC, DREC); -- OK: AI-00037
     PACKAGE N9 IS NEW PK(UARR, CARR, CARR, CARR); -- ERROR: UARR IS
                                                   -- UNCONSTRAINED.
     PACKAGE N10 IS NEW PK(CARR, UARR, CARR, CARR);-- ERROR: UARR IS
                                                   -- UNCONSTRAINED.
     PACKAGE N11 IS NEW PK(CARR, CARR, UARR, CARR);-- ERROR: UARR IS
                                                   -- UNCONSTRAINED.
     PACKAGE N12 IS NEW PK(CARR, CARR, CARR, UARR);-- ERROR: UARR IS
                                                   -- UNCONSTRAINED.
