...
--     WITHIN A GENERIC UNIT, THEN OPERATIONS ON VALUES OF THE
--     TYPE ARE NOT AFFECTED. (THE SMALLEST SIZE APPROPRIATE FOR
--     A SIGNED REPRESENTATION IS SPECIFIED.)
...
PROCEDURE CD2A24B IS

     BASIC_SIZE : CONSTANT := 4;

BEGIN
     TEST ("CD2A24B", "CHECK THAT IF A SIZE CLAUSE (SPECIFYING THE " &
                      "SMALLEST APPROPRIATE SIZE FOR A SIGNED " &
                      "REPRESENTATION) AND AN ENUMERATION " &
                      "REPRESENTATION CLAUSE ARE GIVEN FOR AN " &
                      "ENUMERATION TYPE WITHIN A GENERIC UNIT, THEN " &
                      "OPERATIONS OF THE TYPE ARE NOT AFFECTED");
