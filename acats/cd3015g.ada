...
--     WHEN THERE IS AN ENUMERATION CLAUSE FOR THE PARENT, THE DERIVED
...
BEGIN
     ...
     TEST ("CD3015G", "IF ENUMERATION REPRESENTATION CLAUSES " &
                      "ARE ALLOWED, CHECK THAT WHEN THERE IS AN " &
                      "ENUMERATION CLAUSE FOR THE PARENT, THE " &
