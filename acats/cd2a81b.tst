...
--     ACCESS TYPE IN GENERIC PROCEDURES, THEN OPERATIONS ON VALUES
--     OF SUCH A TYPE ARE NOT AFFECTED BY THE REPRESENTATION CLAUSE.

-- HISTORY:
--     JET 08/31/87  CREATED ORIGINAL TEST.
--     DHH 04/14/89  DELETED APPLICABILITY CRITERIA AND CHANGED
...
PROCEDURE CD2A81B IS

     BASIC_SIZE : CONSTANT := $ACC_SIZE;

BEGIN

     TEST ("CD2A81B", "CHECK THAT WHEN A SIZE SPECIFICATION IS " &
                      "GIVEN FOR AN ACCESS TYPE IN GENERIC " &
