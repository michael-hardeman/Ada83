...
-- OBJECTIVE:
--     IF ENUMERATION REPRESENTATION CLAUSES ARE ALLOWED IN GENERIC
--     UNITS, CHECK THAT WHEN THERE IS AN ENUMERATION CLAUSE FOR THE
--     PARENT,THE DERIVED TYPE CAN BE USED CORRECTLY IN ORDERING
...
BEGIN
     ...
     TEST ("CD3015I", "IF ENUMERATION REPRESENTATION CLAUSES ARE " &
                      "ALLOWED IN GENERIC UNITS, CHECK THAT WHEN " &
                      "THERE IS AN ENUMERATION CLAUSE FOR THE PARENT," &
                      " THE DERIVED TYPE CAN BE USED CORRECTLY IN " &
