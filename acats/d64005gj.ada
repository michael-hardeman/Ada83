...
SEPARATE (D64005G0M.D64005GA.D64005GB.D64005GC.D64005GD.D64005GE.
          D64005GF.D64005GG.D64005GH.D64005GI)
...
BEGIN
     ...
     T.S (T.E+1 .. T.E+N) := D64005G0M.V & D64005GA.V & D64005GB.V &
                             ...
                             D64005GI.V & D64005GJ.V;
     T.E := T.E + N;

     CASE C IS

          WHEN '1' =>
               D64005GK (LEVEL'SUCC(L), IDENT_CHAR('1'), T);

          WHEN '2' =>
               D64005GJ (L, IDENT_CHAR('3'), T);

          WHEN '3' =>
               D64005GK (LEVEL'SUCC(L), IDENT_CHAR('2'), T);
     END CASE;

     -- APPEND ALL L AND C TO T IN REVERSE ORDER.
     T.S (T.E+1 .. T.E+N) := D64005GJ.L & D64005GJ.C &
