...
--     ACCESS TYPE, THEN SUCH A TYPE CAN BE PASSED AS AN ACTUAL
...
BEGIN
     ...
     TEST ("CD2A81E", "CHECK THAT WHEN A SIZE SPECIFICATION IS " &
                      "GIVEN FOR AN ACCESS TYPE, THEN " &
                      "SUCH A TYPE CAN BE PASSED AS AN ACTUAL " &
                      "PARAMETER TO GENERIC PROCEDURES");
