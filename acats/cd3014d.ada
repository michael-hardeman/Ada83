...
--     UNITS, CHECK THAT THE TYPE CAN BE USED CORRECTLY IN ORDERING
...
BEGIN
     ...
     TEST ("CD3014D", "IF ENUMERATION REPRESENTATION CLAUSES ARE " &
                      "ALLOWED IN GENERIC UNITS, CHECK THAT THE TYPE " &
