...
-- THIS TEST USES 6 LEVELS OF NESTED RECURSIVE PROCEDURES (SEPARATELY
-- COMPILED AS SUBUNITS).

-- SEPARATE FILES ARE:
--   D64005E0M THE MAIN PROCEDURE.
--   D64005EA  A RECURSIVE PROCEDURE SUBUNIT OF D64005E0M.
--   D64005EB  A RECURSIVE PROCEDURE SUBUNIT OF D64005EA.
--   D64005EC  A RECURSIVE PROCEDURE SUBUNIT OF D64005EB.
--   D64005ED  A RECURSIVE PROCEDURE SUBUNIT OF D64005EC.
--   D64005EE  A RECURSIVE PROCEDURE SUBUNIT OF D64005ED.
--   D64005EF  A RECURSIVE PROCEDURE SUBUNIT OF D64005EE.
...
PROCEDURE D64005E0M IS

     SUBTYPE LEVEL IS CHARACTER RANGE 'A' .. 'F';
...
BEGIN
     TEST ("D64005E", "CHECK THAT NON-LOCAL VARIABLES AND FORMAL " &
                      "PARAMETERS AT ALL LEVELS OF NESTED " &
                      "RECURSIVE PROCEDURES ARE ACCESSIBLE (FOR " &
                      "6 LEVELS OF SEPARATELY COMPILED SUBUNITS)");

     -- APPEND V TO T.
     T.S (T.E+1) := V;
     T.E := T.E + 1;

     D64005EA (IDENT_CHAR(LEVEL'FIRST), IDENT_CHAR('1'), T);
