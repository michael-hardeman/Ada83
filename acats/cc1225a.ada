...
PROCEDURE CC1225A IS
     ...
     PACKAGE BODY P IS
          ...
          AFADDRESS : ADDRESS;
          AADDRESS : ADDRESS;
          ACCFORMSTORAGE_SIZE : INTEGER;
          ACCSTORAGE_SIZE : INTEGER;
          INT : INTEGER := 5;
     BEGIN
          ...
          AFADDRESS := AF'ADDRESS;

          IF ACCFORM'BASE'SIZE < ACCFORM'SIZE THEN
               FAILED ("IMPROPER VALUE FOR ACCFORM'BASE'SIZE");
          END IF;

          ACCFORMSTORAGE_SIZE := ACCFORM'STORAGE_SIZE;
          ...
          IF ACC'BASE'SIZE < ACC'SIZE THEN
               FAILED ("IMPROPER VALUE FOR ACC'BASE'SIZE");
          END IF;

          AADDRESS := A'ADDRESS;

          ACCSTORAGE_SIZE := ACC'STORAGE_SIZE;
