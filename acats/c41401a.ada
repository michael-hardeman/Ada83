...
BEGIN
     ...
     BEGIN
          ...
          FAILED ("CONSTRAINT_ERROR NOT RAISED - 13");
     EXCEPTION
          WHEN CONSTRAINT_ERROR =>
               NULL;
          WHEN OTHERS =>
     ...
     BEGIN
          ...
          FAILED ("CONSTRAINT_ERROR NOT RAISED - 15");
     EXCEPTION
          WHEN CONSTRAINT_ERROR =>
               NULL;
          WHEN OTHERS =>
     ...
     BEGIN
          ...
          FAILED ("CONSTRAINT_ERROR NOT RAISED - 17");
     EXCEPTION
          WHEN CONSTRAINT_ERROR =>
               NULL;
          WHEN OTHERS =>
     ...
     BEGIN
          ...
          FAILED ("CONSTRAINT_ERROR NOT RAISED - 21");
     EXCEPTION
          WHEN CONSTRAINT_ERROR =>
               NULL;
          WHEN OTHERS =>
     ...
     BEGIN
          ...
          FAILED ("CONSTRAINT_ERROR NOT RAISED - 23");
     EXCEPTION
          WHEN CONSTRAINT_ERROR =>
               NULL;
          WHEN OTHERS =>
